          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4">
              ...
              <ul className="mt-2 flex list-disc flex-col gap-1.5 pl-4 text-[13px] leading-snug text-slate-600">
                ...
                <li>Coverage targets are hard minimums: no slot is ever left at 0, and any shortfall is at most 1 dispatcher deep, outside the peaks — with one bounded, flagged exception: the 8–9 PM shoulder may sit 1 below target when a closer takes its dinner break there to keep the evening staircase (above).</li>
