          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4">
              ...
              <ul className="mt-2 flex list-disc flex-col gap-1.5 pl-4 text-[13px] leading-snug text-slate-600">
                ...
                <li>Shift shape: a shift runs at least 4 hours total, and a work block within a shift can be as short as 2 hours. The short block lets one body take an early break (e.g. 9–11 AM, break, then 11:30 AM–4 PM) and <em>bridge</em> the lunch-to-afternoon handoff — covering the 2–2:30 PM seam continuously — instead of the schedule spawning a separate short filler shift.</li>
